...
export const tool: Tool = {
  name: 'create_after_sales_service_conditions_return_policies',
  description:
...
export const handler = async (client: AllegroAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.afterSalesServiceConditions.returnPolicies.create(body));
};
