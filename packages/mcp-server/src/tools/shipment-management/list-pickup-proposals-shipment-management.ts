...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/shipment-management/pickup-proposals',
  operationId: 'getPickupProposals',
};

export const tool: Tool = {
  name: 'list_pickup_proposals_shipment_management',
  description:
...
export const handler = async (client: AllegroAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.shipmentManagement.listPickupProposals(body));
};
