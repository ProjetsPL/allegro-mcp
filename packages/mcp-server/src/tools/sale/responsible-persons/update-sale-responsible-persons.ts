...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/sale/responsible-persons/{id}',
  operationId: 'responsiblePersonsPUT',
};

export const tool: Tool = {
  name: 'update_sale_responsible_persons',
  description:
...
export const handler = async (client: AllegroAPI, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.sale.responsiblePersons.update(id, body));
};
