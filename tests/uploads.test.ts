import fs from 'fs';
import type { ResponseLike } from 'allegro-api/internal/to-file';
import { toFile } from 'allegro-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('allegro-api/core/uploads');
    await expect(
